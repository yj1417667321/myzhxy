		...
		"972a": function(e, t, s) {
			...
			var a = function() {
					...
					return s("div", [s("el-row", [s("el-col", {
						...
						staticClass: "fl-left avatar-box"
					}, [s("div", {
						...
						staticClass: "user-personality"
					}, [s("div", {
						staticClass: "nickName"
					}, [e._v(" " + e._s(e.userInfo
						.name) + " ")])]), s("div", {
					...
					"p", {
						...
						on: {
							click: e.resetUserForm
						}
					}, [e._v("重 置")]), s("el-button", {
						attrs: {
							type: "primary"
						},
						on: {
				...
				u = {
					...
					methods: {
						...
						showUserUpdate: function() {
							this.userForm = Object(o["a"])({}, this.userInfo), this
								.userDialogVisible = !0
						},
						...
						handleAvatarSuccess: function(e, t) {
							this.userForm.portraitPath = e.data, this.$refs.userForm.validateField(
								"portraitPath")
						},
						beforeAvatarUpload: function(e) {
							var t = ["image/jpeg", "image/png"].indexOf(e.type) >= 0,
								s = e.size / 1024 / 1024 < 10;
							return t || this.$message.error("上传头像图片只能是 JPG/PNG 格式!"), s || this.$message
								.error("上传头像图片大小不能超过 10MB!"), t && s
						}
					}
				},
				d = u,
